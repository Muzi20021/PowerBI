...
SELECT dbo.DimCustomer.GeographyKey, dbo.DimCustomer.CustomerKey, dbo.DimCustomer.CustomerAlternateKey, dbo.DimCustomer.Title, dbo.DimCustomer.FirstName, dbo.DimCustomer.MiddleName, dbo.DimCustomer.LastName, 
				  ...
				  END AS 'TRANSAKCJE',
				  CASE
				  WHEN COUNT(dbo.FactInternetSales.SalesOrderNumber) = 1 THEN '1'
				  WHEN COUNT(dbo.FactInternetSales.SalesOrderNumber) = 2 THEN '2'
				  WHEN COUNT(dbo.FactInternetSales.SalesOrderNumber) = 3 THEN '3'
				  WHEN COUNT(dbo.FactInternetSales.SalesOrderNumber) = 4 THEN '4'
				  ELSE '5 i wiecej'
				  END AS 'Transakcje 2'
